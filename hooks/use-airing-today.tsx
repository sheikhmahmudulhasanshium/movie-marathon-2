...
const useAiringToday = (media_type: string): UseAiringTodayResult => {
    ...
    useEffect(() => {
        const fetchAiringToday = async () => {
            try {
                ...
                const airing_todayResults = response.data.results;
                ...
                const detailedAiringToday = await Promise.all(
                    airing_todayResults.map(async (now: any) => {
                ...
                setAiringToday(detailedAiringToday);
            } catch (err) {
